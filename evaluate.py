...
def _compile_pred_metrics(iou_matrix, pred_info):
    """
...
def evaluate_single_prediction(gt_label, pred_label, pred_info):
    """
    ...
    pred_metrics = _compile_pred_metrics(iou_matrix, pred_info)
